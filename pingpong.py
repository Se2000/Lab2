...
PILKA_PREDKOSC_X = 6
PILKA_PREDKOSC_Y = 6
pilka_obr = pygame.Surface([PILKA_SZER, PILKA_WYS], pygame.SRCALPHA,
32).convert_alpha()
...
elif pilka_prost.centerx <
paletka2_prost.centerx:
paletka2_prost.x -= AI_PREDKOSC
...
OKNOGRY.blit(pilka_obr, pilka_prost) pygame.display.update()
fpsZegar.tick(FPS)
